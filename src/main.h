...
#define START_MASTERNODE_PAYMENTS_TESTNET 1591628935
#define START_MASTERNODE_PAYMENTS 1591628935 // Epochtime

static const int64_t DARKSEND_COLLATERAL = (100000*COIN); //100000
static const int64_t DARKSEND_FEE = (0.0001*COIN);
static const int64_t DARKSEND_POOL_MAX = (999999.99*COIN); //limit of 999999.99 for a single mixing session only
static const int REWARD_START = 51;
static const int FIRST_BLOCK = 1;
static const int FAIR_LAUNCH_BLOCK = 50;
static const int YEAR1_BLOCKS = 525600;
static const int YEAR2_BLOCKS = 1051200;
